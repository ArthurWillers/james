                    ...
                    <div class="mt-8 pt-6 border-t border-neutral-100">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            @foreach($settlementGroup->getMedia('attachments') as $media)
                                <a href="{{ route('settlements.groups.attachment', [$settlementGroup, $media, $media->file_name]) }}" target="_blank" class="flex items-center gap-3 p-3 border border-neutral-200 rounded-lg bg-neutral-50 hover:bg-neutral-100 hover:border-neutral-300 transition-colors group">
