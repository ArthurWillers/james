                ...
                <x-table.row class="hidden sm:grid sm:grid-cols-[2fr_1fr_1.5fr]">
                    ...
                    <x-table.cell align="right">
                        <div class="flex justify-end gap-2 w-full">
                            ...
                            <x-button type="button" color="outline" class="bg-white hover:bg-red-50 text-red-600 border-red-200" @click="openForceDelete({{ $account->id }}, {{ Js::from($account->name) }})">
                            ...
                            <div class="shrink-0">
                                <x-dropdown position="bottom-end" accent contentClass="min-w-max">
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <button type="button" class="w-full flex items-center gap-2 px-4 py-2 text-sm text-red-600 hover:bg-neutral-100 cursor-pointer" @click="openForceDelete({{ $account->id }}, {{ Js::from($account->name) }})">
