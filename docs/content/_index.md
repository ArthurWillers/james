---
title: "Documentação do Projeto James"
layout: hextra-home
---
...
{{< hextra/hero-subtitle >}}
  Portal central da documentação técnica, decisões arquiteturais e guias de desenvolvimento da aplicação.
{{< /hextra/hero-subtitle >}}
</div>
...
{{< hextra/feature-grid >}}
  ...
  {{< hextra/feature-card
    ...
    subtitle="Acesse o código-fonte e colabore no repositório oficial."
    icon="github"
    link="https://github.com/ArthurWillers/james"
    class="hx:min-h-[280px]"
