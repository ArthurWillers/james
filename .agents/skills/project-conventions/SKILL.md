...
7. **Ícones:** Utilize a biblioteca Heroicons (`<x-heroicon-...>`) por padrão. Caso sinta falta de ícones específicos (ex: itens do cotidiano para tags), é permitido o uso de outras bibliotecas via pacotes do ecossistema Blade Icons (como Ionicons). Não adicione SVGs manualmente nas views.
