...
return [
    ...
    */
    'default_tags' => [
        ['name' => 'Salário', 'icon' => 'heroicon-o-currency-dollar', 'color_hex' => '#22c55e'],
        ['name' => 'Auxílio', 'icon' => 'heroicon-o-hand-raised', 'color_hex' => '#10b981'],
        ['name' => 'Pagamento', 'icon' => 'heroicon-o-credit-card', 'color_hex' => '#3b82f6'],
        ...
        ['name' => 'Lanches', 'icon' => 'heroicon-o-cake', 'color_hex' => '#fbbf24'],
