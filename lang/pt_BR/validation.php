...
return [
    ...
    | as regras de tamanho. Sinta-se à vontade para ajustar cada uma delas aqui.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de idioma a seguir são usadas para trocar nossos espaços reservados
    | de atributos por algo mais amigável, como "Endereço de E-Mail" em
    | vez de "email". Isso nos ajuda a tornar nossas mensagens mais expressivas.
    |
    */
    ...
    'attributes' => [
        ...
        'relationship_category' => 'categoria de relacionamento',
        'notes' => 'anotações',
        'phones' => 'telefones',
        'phones.*.number' => 'número do telefone',
        'emails' => 'e-mails',
        'emails.*.value' => 'endereço de e-mail',
        'avatar' => 'avatar',
    ],
